...
export function Header(props: HeaderProps) {
  ...
  const loadingBarVisible =
    !!userSlice.currentNumProcessingDocs || !!context?.isLoading;
...
export function sortByTransactionDate(arr: Receipt[]): Receipt[] {
  return [...arr].sort((a, b) => {
    const dateA = validateDate(a.transaction_date_time);
    const dateB = validateDate(b.transaction_date_time);
